=== Plugin Name ===
Contributors: templaries
Donate link: http://www.devlopez.com/
Tags: csv, pods
...
After the standard manual or automatic plugin installation procedure, you'll be able to access the plugin settings page Tools -> CSV Importer For Pods
